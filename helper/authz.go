...
// PermissionSet menyimpan pemetaan role -> daftar permission, dimuat sekali saat start.
...
// Can SELALU false untuk role/permission yang tidak dikenal, atau penerima nil.
