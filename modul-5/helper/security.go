...
// Nilai 12 adalah kompromi lazim: cukup lambat bagi penyerang,
...
// math/rand TIDAK boleh dipakai di sini karena hasilnya dapat diperkirakan
// bila seed-nya diketahui.
